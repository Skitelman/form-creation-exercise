    ...
    <div className="my-2">
      <div className="grid grid-cols-2 gap-2">
        <input
          ...
          className="border-2 rounded bg-gray-300 p-1 w-full"
        />
        <input
          type="text"
      ...
      <input
          ...
          className="col-span-2 border-2 rounded bg-gray-300 p-1 w-full my-2"
        />
        <h3 className="col-span-2 text-gray-50 font-bold">Payment Details</h3>
        <input
          type="text"
